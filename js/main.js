...
function Resume() {
  window.open('https://docs.google.com/document/d/1zod003GrtjRJcu75GMhkqi49aoV57xh5ghbNYqRTCkA/edit?usp=drive_link', '_blank')
}

function Github() {
  window.open('https://github.com/dgashandy/', '_blank')
}
...
function init() {
  ...
  const words = ["I'm Mohammad Daffa Gashandy.", "I'm a Data Scientist."]
  const wait = 2250;
  // Init TypeWriter
